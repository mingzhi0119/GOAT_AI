...
- Heavy decision package examples:
  ...
  [RUNTIME_PLATFORM_SHARED_FOUNDATIONS_DECISION_PACKAGE.md](../architecture/RUNTIME_PLATFORM_SHARED_FOUNDATIONS_DECISION_PACKAGE.md)
  [DESKTOP_DISTRIBUTION_MATURITY_DECISION_PACKAGE.md](../architecture/DESKTOP_DISTRIBUTION_MATURITY_DECISION_PACKAGE.md)
  [CODE_SANDBOX_RUNTIME_FOLLOW_ON_DECISION_PACKAGE.md](../architecture/CODE_SANDBOX_RUNTIME_FOLLOW_ON_DECISION_PACKAGE.md)
  [FRONTEND_FRAMEWORK_DIRECTION_DECISION_PACKAGE.md](../architecture/FRONTEND_FRAMEWORK_DIRECTION_DECISION_PACKAGE.md)

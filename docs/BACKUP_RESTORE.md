...
- Source DB: `GOAT_LOG_PATH` (default `<repo>/var/chat_logs.db`); includes `sessions`, `session_messages`, and related tables (see [SESSION_MESSAGES_MIGRATION.md](SESSION_MESSAGES_MIGRATION.md)).

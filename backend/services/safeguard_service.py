"""Typed safeguard policy engine for chat input/output moderation."""
...
class SafeguardService(Protocol):
    """Typed moderation boundary for request/response text."""
...
class RuleBasedSafeguardService:
    """Conservative rule-based safeguard layer for campus-facing chat."""
